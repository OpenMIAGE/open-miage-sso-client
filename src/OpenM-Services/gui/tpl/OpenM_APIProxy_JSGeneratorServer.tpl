...
{/if}{foreach from=$methods item=method}{if $min!=true}
    {/if}{$method.name}:{if $min!=true} {/if}function({foreach from=$method.args item=arg}{if $min!=true}{$arg.name}{else}{$arg.parameterName|replace:'arg':'c'}{/if},{if $min!=true} {/if}{/foreach}{if $min!=true}callback_function{else}cb{/if},{if $min!=true} error_callback_function{else}ecb{/if}){literal}{{/literal}{if $min!=true} 
        ...
        {/if}var {if $min!=true}callback_function_defined{else}cbd{/if}{if $min!=true} {/if}={if $min!=true} {/if}false;{if $min!=true} 
        ...
        {/if}$.each({if $min!=true}data{else}d{/if},{if $min!=true} {/if}function({if $min!=true}key{else}k{/if},{if $min!=true}value{else}v{/if}){literal}{{/literal}{if $min!=true} 
            {/if}if(typeof({if $min!=true}value{else}v{/if}){if $min!=true} {/if}=={if $min!=true} {/if}'function'){literal}{{/literal}{if $min!=true} 
                {/if}if({if $min!=true}callback_function_defined{else}cbd{/if}){literal}{{/literal}{if $min!=true} 
                    {/if}{if $min!=true}error_callback_function{else}ecb{/if}{if $min!=true} {/if}={if $min!=true} {/if}{if $min!=true}value{else}v{/if};{if $min!=true} 
                ...
                {/if}else{literal}{{/literal}{if $min!=true} 
                    ...
                    {/if}{if $min!=true}callback_function_defined{else}cbd{/if}{if $min!=true} {/if}={if $min!=true} {/if}true;{if $min!=true} 
                {/if}{literal}}{/literal}{if $min!=true} 
            {/if}{literal}}{/literal}{if $min!=true} 
        ...
        {/if}else{literal}{{/literal}{if $min!=true} 
            ...
            {/if}if(typeof({if $min!=true}error_callback_function{else}ecb{/if}){if $min!=true} {/if}=={if $min!=true} {/if}'function'){if $min!=true} 
                {/if}{if $min!=true}ajax{else}a{/if}.error{if $min!=true} {/if}={if $min!=true} {/if}function({if $min!=true}data{else}d{/if}){literal}{{/literal}{if $min!=true}error_callback_function{else}ecb{/if}({if $min!=true}data{else}d{/if}){literal}}{/literal};{if $min!=true} 
