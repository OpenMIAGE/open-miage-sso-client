...
{/if}{foreach from=$methods item=method}{if $min!=true}
    {/if}{$method.name}:{if $min!=true} {/if}function({foreach from=$method.args item=arg}{if $min!=true}{$arg.name}{else}{$arg.parameterName|replace:'arg':'c'}{/if},{if $min!=true} {/if}{/foreach}{if $min!=true}callback_function{else}cb{/if}){literal}{{/literal}{if $min!=true} 
        {/if}var {if $min!=true}ajax{else}a{/if}{if $min!=true} {/if}={if $min!=true} {/if}{literal}{{/literal}{if $min!=true} 
            ...
            {/if}data:{if $min!=true} {/if}'',{if $min!=true} 
        ...
        {/if}$.each({if $min!=true}data{else}d{/if},{if $min!=true} {/if}function(k,v){literal}{{/literal}{if $min!=true} 
            {/if}if(typeof(v){if $min!=true} {/if}=={if $min!=true} {/if}"function"){literal}{{/literal}{if $min!=true} 
                {/if}{if $min!=true}callback_function{else}cb{/if}{if $min!=true} {/if}={if $min!=true} {/if}v;{if $min!=true} 
                {/if}return{if $min!=true} {/if}false;{if $min!=true} 
            {/if}{literal}}{/literal}{if $min!=true} 
            {/if}{if $min!=true}ajax{else}a{/if}.data[k]{if $min!=true} {/if}={if $min!=true} {/if}v;{if $min!=true} 
        {/if}{literal}}{/literal}){if $min!=true} 
        {/if}if({if $min!=true}callback_function{else}cb{/if}===undefined){literal}{{/literal}{if $min!=true} 
            ...
            {/if}var r;{if $min!=true} 
            {/if}{if $min!=true}ajax{else}a{/if}.success{if $min!=true} {/if}={if $min!=true} {/if}function({if $min!=true}data{else}d{/if}){literal}{{/literal}r={if $min!=true}data{else}d{/if}{literal}}{/literal};{if $min!=true} 
            {/if}$.ajax({if $min!=true}ajax{else}a{/if});{if $min!=true} 
            {/if}return r;{if $min!=true} 
